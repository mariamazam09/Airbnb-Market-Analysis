...
<p align="center">
  <img src="https://poliva.vn/wp-content/uploads/2019/09/airbnb-la-gi-1.jpg" alt="Preview" width="600">
</p>
...
## Dataset Overview  
- **Source**: [Airbnb Dataset Link](https://insideairbnb.com/get-the-data/)


## Summary of Key Findings  
- Neighborhoods With the Highest Number of Listings: **Rideau-Vanier** leads with the highest number of listings.
- Listings with the Highest Demand: **Rideau-Vanier** leads with the highest occupancy percentage i.e., 34.48%
- Popular Properties Among Guests: **Campsites, entire cabins, and chalets** are the top-rated properties based on guest reviews.
- Earnings by Host Type: **Superhosts** drive higher revenue.
